...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "James Powel" => "poweljames319@gmail.com" }
  # Or just: spec.author    = "James Powel"
  # spec.authors            = { "James Powel" => "poweljames319@gmail.com" }
  # spec.social_media_url   = "https://twitter.com/James Powel"
